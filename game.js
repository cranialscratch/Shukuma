...
const CHANGELOG = [
  ...
  },
  {
    version: "2.0.64",
    date: "2026-06-30",
    title: "Colour theme polish: restore Default brand, redesign Pride & Trans, fix HC & protanopia contrast",
    changes: [
      "Default theme restored exactly to our original brand palette (purple #7c4dff, green #4ade80)",
      "Pride: completely redesigned — vivid violet brand, crisp white board, bright readable green/red/orange, full rainbow pulse animation",
      "Trans: redesigned around the flag — sky blue brand, palest blush-pink board, white tiles, soft pink selection, clear green/rose valid/invalid",
      "High Contrast: fixed white-on-yellow in dark mode (selected tile now deep blue); lightened dark neutral tiles for better visibility; fixed light mode played/valid/invalid text to white for legibility",
      "Red-Green (protanopia): played tiles darkened from #0D8A9A to #0A7282 (light) and #0A6078 (dark) — white text now meets AA contrast on both",
    ],
  },
  {
    version: "2.0.63",
...
var THEMES = [
  ...
  { id:"default", name:"Default", emoji:"✨", cat:"brand", auto:null,
    vars:{
      "--brand":"#7c4dff",               "--brand-dark":"#5e35b1",
      "--board-bg":"#f2f2f7",            "--page-bg":"#f2f2f7",
      "--card-bg":"#ffffff",
      "--sheet-bg":"#f2f2f7",            "--word-box-bg":"#f0f0ec",
      "--stat-box-bg":"#f7f7f5",
      "--text-primary":"#1c1c1e",        "--text-secondary":"#6e6e73",
      "--text-muted":"#9ca3af",          "--prompt-color":"#9ca3af",
      "--icon-color":"#6e6e73",          "--lb-row-border":"#f0f0ec",
      "--tile-neutral":"#ffffff",        "--tile-neutral-stroke":"#e5e7eb",
      "--tile-blank":"#f3f0eb",          "--tile-text":"#1f2937",
      ...
      "--tile-pulse-fill":"#a78bfa",
      // Dark counterparts
      "--dk-brand":"#a78bfa",            "--dk-brand-dark":"#7c4dff",
      "--dk-board-bg":"#1c1c1e",         "--dk-card-bg":"#2c2c2e",
      "--dk-sheet-bg":"#1c1c1e",         "--dk-word-box-bg":"#2c2c2e",
      "--dk-stat-box-bg":"#3a3a3c",
      "--dk-text-primary":"#f2f2f7",     "--dk-text-secondary":"#aeaeb2",
      "--dk-text-muted":"#636366",       "--dk-prompt-color":"#636366",
  ...
  { id:"protanopia", name:"Red-Green", emoji:"👁", cat:"access", auto:null,
    vars:{
      ...
      "--tile-played":"#0A7282",         "--tile-played-stroke":"#086070",
  ...
  { id:"highcontrast", name:"High Contrast", emoji:"◑", cat:"access", auto:null,
    vars:{
      ...
      "--dk-tile-neutral":"#2A2A2A",     "--dk-tile-neutral-stroke":"#FFFFFF",
      "--dk-tile-blank":"#0D0D0D",       "--dk-tile-text":"#FFFFFF",
      "--dk-tile-text-light":"#000000",
      "--dk-tile-selected":"#0044CC",    "--dk-tile-selected-stroke":"#0033AA",
  ...
  // reads easily on it). Valid/invalid are clear and universally readable.
  { id:"trans", name:"Trans", emoji:"⚧️", cat:"community",
    ...
    vars:{
      ...
      "--stat-box-bg":"#FEF4F8",
      "--text-primary":"#1A202C",        "--text-secondary":"#5A7A8A",
      "--text-muted":"#90A8B8",          "--prompt-color":"#90A8B8",
      ...
      "--dk-text-primary":"#EEF6FF",     "--dk-text-secondary":"#7AB8D0",
      "--dk-text-muted":"#4A7890",       "--dk-prompt-color":"#4A7890",
