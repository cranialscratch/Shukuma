...
const TARGET_WORDS = [
  ...
  // ── Extended forms (plurals, -ING, -TION, -MENT, -ISED/-IZED) ──
  'INVESTMENTS','SOCIALISING','SOCIALIZING','ENTERTAINING','CELEBRATIONS',
  'DISCOVERING','QUESTIONING','ESTABLISHING','FOUNDATIONS','ENCOURAGING',
  'INTERESTING','ORIGINATING','CONTRIBUTING','VOLUNTEERING','BROADCASTING',
  'EXPERIENCING','COMMUNICATING','ILLUSTRATING','ACCELERATING','BREATHTAKING',
  'COLLABORATING','DEMONSTRATING','INVESTIGATING','ACCOMPLISHING','CONTEMPLATING',
  'REVOLUTIONISE','REVOLUTIONIZE','MODERNISATION','MODERNIZATION','SUSTAINABILITY',
  'PARTNERSHIPS','ACHIEVEMENTS','NEGOTIATIONS','TRANSFORMING','UNDERSTANDING',
  'STRENGTHENING','STRAIGHTENING','MANUFACTURING','VOLUNTEERING','TRANSITIONING',
  'ACCUMULATING','ADMINISTERING','BRAINSTORMING','CAPITALISING','CAPITALIZING',
  'CATEGORISING','CATEGORIZING','CENTRALISING','CENTRALIZING','CHARACTERISING',
  'CHOREOGRAPHED','COLLABORATORS','COMMEMORATING','COMMISSIONING','COMMUNICATORS',
  'CONSOLIDATING','DECENTRALISED','DECENTRALIZED','DEMOCRATISING','DEMOCRATIZING',
  'ENERGETICALLY','FAMILIARISING','FAMILIARIZING','GLOBALISATION','GLOBALIZATION',
  'HARMONISATION','HARMONIZATION','HOSPITALISING','HOSPITALIZING','HUMANITARIANS',
  'INDIVIDUALISE','INDIVIDUALIZE','INDUSTRIALISE','INDUSTRIALIZE','INITIALISING',
  'INTERNALISING','INTERNALIZING','LEGITIMATIONS','MODERNISATIONS','NATIONALISING',
  'NATIONALIZING','NORMALISATION','NORMALIZATION','ORGANISATIONS','OUTPERFORMING',
  'OVERESTIMATED','PERSONALISING','PERSONALIZING','PHILANTHROPIST','POPULARISING',
  'POPULARIZING','PRESENTATIONS','PROFESSIONALISE','PROFESSORSHIP','RATIONALISING',
  'RATIONALIZING','REALISTICALLY','RECOGNISABLE','REORGANISATION','REORGANIZATION',
  'RESTRUCTURING','REVOLUTIONISED','REVOLUTIONIZED','SCANDALISING','SCANDALIZING',
  'SPECIALISATION','SPECIALIZATION','STANDARDISING','STANDARDIZING','STREAMLINING',
  'SUMMARISING','SUMMARIZING','SYSTEMATISING','SYSTEMATIZING','TECHNOLOGISTS',
  'TRANSITIONING','UNDERESTIMATED','UNIVERSALISING','UNIVERSALIZING','VOLUNTEERINGS',
];

// Stem extractor — strips common suffixes so INVESTMENT and INVESTMENTS don't both appear
function getStem(word) {
  const w = word.toUpperCase();
  const suffixes = ['INGS','TION','MENT','NESS','LESS','ISED','IZED','ING','ION','EST','LLY','LY','ER','ED','ES','S'];
...
// De-duplicate by stem and filter to valid length range
...
const VALID_WORDS = TARGET_WORDS
  ...
  .filter(w => {
    const s = getStem(w);
    if (stemSeen.has(s)) return false;
    stemSeen.add(s);
    return true;
  });
